    ...
    int digArtifacts(int n, vector<vector<int>>& artifacts, vector<vector<int>>& dig) {
        ...
        for (auto i : artifacts){
            if (i[0] == i[2] && i[1] == i[3]){
                ...
                if (i[1] - i[3] == 1 || i[1] - i[3] == -1){
                    if (n_n[i[0]][i[1]] == 1 && n_n[i[2]][i[3]] == 1)
                        ans++;
                }
                else {
                    if (n_n[i[0]][i[1]] == 1 && n_n[i[2]][i[3]] == 1)
                        if (n_n[i[0]][i[1] + 1] == 1 && n_n[i[2]][i[3] - 1] == 1)
                            ans++;
                }
            }
            else if (i[1] == i[3]){
                if ((i[0] - i[2] == 1 || i[0] - i[2] == -1)){
                    if (n_n[i[0]][i[1]] == 1 && n_n[i[2]][i[3]] == 1)
                        ans++;
                }
                else {
                    if (n_n[i[0]][i[1]] == 1 && n_n[i[2]][i[3]] == 1)
                        if (n_n[i[0] + 1][i[1]] == 1 && n_n[i[2] - 1][i[3]] == 1)
                            ans++;
                }
            }
            else{
                if ((n_n[i[0]][i[1]] == 1 && n_n[i[2]][i[3]] == 1) && (n_n[i[0]][i[3]] == 1 && n_n[i[2]][i[1]] == 1))
                    ans++;
            }
        }
        return ans;
